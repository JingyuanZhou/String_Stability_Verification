...
if __name__ == "__main__":
    ...
    # System parameters
    n = 5  # Number of inverters
    V = [325.3] * n  # Voltage magnitude (V)
    B = [[-0.0056, -0.0112, 0, 0, 0],
         [-0.0112, -0.0151, -0.0039,0,0],
         [0,-0.0112, -0.0151, -0.0039,0],
         [0, 0 ,-0.0112, -0.0151, -0.0039],
         [0, 0, 0, -0.0039, -0.0112]]  # Line susceptances
