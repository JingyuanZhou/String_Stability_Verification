...
plt.plot(0, 0, 'r*', markersize=14, label='Equilibrium', markeredgecolor='white', markeredgewidth=1)
plt.xlabel('Position Error (m)', fontsize=26, labelpad=10)
plt.ylabel('Velocity Error (m/s)', fontsize=26, labelpad=10)
