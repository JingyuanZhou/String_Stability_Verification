...
num_ce_list = np.load("data/num_ce_list_10.npy")
num_veri_time_list = np.load("data/num_veri_time_list_10.npy")
num_training_time_list = np.load("data/num_training_time_list_10.npy")
total_time = np.load("data/total_time_10.npy")
