...
class CombinedNetwork(nn.Module):
    def __init__(self, controllers, V_net, cav_indices, state_dims, system_dynamics):
        ...
        W_state_with_preceding[3, 2] = 1.0
        W_state_with_preceding[4, 0] = 1.0
        W_state_with_preceding[5, 1] = 1.0
    ...
    def forward(self, x):
        ...
        #print("W", self.W_state_with_preceding)
        #print("x_with_preceding", x_with_preceding)
