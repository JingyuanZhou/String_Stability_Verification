...
num_ce_list = np.load("data/num_ce_list_20_shared.npy")
num_veri_time_list = np.load("data/num_veri_time_list_20_shared.npy")
num_training_time_list = np.load("data/num_training_time_list_20_shared.npy")
total_time = np.load("data/num_total_time_list_20_shared.npy")


print(num_ce_list)
print(num_veri_time_list)
print(num_training_time_list)
print(total_time)
