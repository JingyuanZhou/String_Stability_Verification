...
num_ce_list = np.load("data/num_ce_list_4.npy")
num_veri_time_list = np.load("data/num_veri_time_list_4.npy")
num_training_time_list = np.load("data/num_training_time_list_4.npy")
total_time = np.load("data/num_total_time_list_4.npy")
