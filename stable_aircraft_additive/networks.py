...
class VectorLyapunovNetwork(nn.Module):
    def __init__(self, input_dim=6, hidden_dim=96, G=None, num_UAVs=3, shared_Lyapunov=True, train_additive=False, intitial_platoon_num=3, additive_platoon_num=3):
        """
...
class CombinedController(nn.Module):
    def __init__(self, input_dim=6, output_dim=3, hidden_dim=64, num_UAVs=3, shared_Lyapunov=True, train_additive=False, intitial_platoon_num=3, additive_platoon_num=3):
